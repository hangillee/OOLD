...
public class StoryStage {
	public void Stage01() {
		...
		Enemy dirtGolem = new Enemy(100, playerDefend+10, 10, "DIRT GOLEM"); //ÁøÈë °ñ·½ Ã¼·Â:100, °ø°İ·Â:ÇÃ·¹ÀÌ¾î ¹æ¾î·Â + 10, ¹æ¾î·Â:20
	...
	public void Stage02() {
		PrintMethods.ClearScreen();
		Enemy stoneGolem = new Enemy(200, 60, 20, "STONE GOLEM"); //ÁøÈë °ñ·½ Ã¼·Â 100, °ø°İ·Â 20, ¹æ¾î·Â 20
		CharacterAct characterAct = new CharacterAct();
